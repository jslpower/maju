<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="AddMessage.aspx.cs" Inherits="Enow.MAJU.Web.Manage.Service.AddMessage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    ...
    <div class="contentbox">
        <div class="firsttable">
            <table cellspacing="0" cellpadding="0" border="0" id="tableInfo">
                <tr>
                    <th>
                        <div style="width:80px;">消息内容：</div>
                    </th>
                    <td>
                        <textarea id="txtContent" cols="140" rows="20" name="txtContent" errmsg="请填写消息内容!"
        ...
        var PageJsDataObj = {
            ...
            submit: function () {
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "AddMessage.aspx?dotype=save&" + $.param(PageJsDataObj.Data),
