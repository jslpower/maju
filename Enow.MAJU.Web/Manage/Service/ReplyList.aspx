<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="ReplyList.aspx.cs" Inherits="Enow.MAJU.Web.Manage.Service.ReplyList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <div class="contentbox">
        <div class="searchbox fixed">
            <span class="searchT">
                <p>
                    &nbsp;&nbsp;消息内容:<asp:Literal ID="LtrMessageContext" runat="server"></asp:Literal>
                    <br />
                    &nbsp;&nbsp;消息关键字：
                    <asp:TextBox ID="txtKeyWord" runat="server" CssClass="input-txt formsize240"></asp:TextBox>
                    &nbsp;&nbsp;发布/反馈日期：
                    ...
                    <asp:Repeater ID="rptList" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="center">
                                     <%#Enow.MAJU.Utility.Utils.GetText2(Eval("Context").ToString(),60,true) %>
                                </td>
                                <td align="center">
                                    <%#Eval("IsSysReply").ToString() == "1" ? "系统消息" : "用户反馈"%>
                                </td>
                                <td align="center">
                                    <%#Eval("IssueTime", "{0:yyyy-MM-dd HH:mm}")%>
                                </td>
                                <td align="center">
                                    <%#GetMemberName(Eval("MemberId").ToString(),Eval("IsSysReply").ToString(),Eval("operatorid").ToString()) %>
                                </td>
                                <td align="center">
                                    <a href="javascript:void(0)" class="transactions" data-rel='<%#Eval("ReplyId") %>'>
