<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="ProductReply.aspx.cs" Inherits="Enow.MAJU.Web.Manage.Product.ProductReply" %>
        ...
        var PageJsDataObj = {
            ...
            submit: function () {
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: "ProductReply.aspx?dotype=save&" + $.param(PageJsDataObj.Data),
