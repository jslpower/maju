<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master" AutoEventWireup="true" CodeBehind="RolesManage.aspx.cs" Inherits="Enow.MAJU.Web.Manage.Sys.RolesManage" %>
...
<div class="contentbox">
    <div class="searchbox fixed"><span class="searchT">
      <p> 角色名称：
        <asp:TextBox ID="txtKeyWord" CssClass="formsize120 input-txt" runat="server"  onkeydown="if(event.which || event.keyCode){if ((event.which == 13) || (event.keyCode == 13)) {return false;}}"/>
        &nbsp;&nbsp;
    ...
    <div class="listbox">
      <div id="tablehead" class="tablehead">
        <ul class="fixed">
          <li><a href="javascript:void(0)" hidefocus="true" class="toolbar_add add_gg"><s class="addicon"></s>新增</a></li>
          <li class="line"></li>
          <li><a href="#" hidefocus="true" class="toolbar_update"><s class="updateicon"></s>修改</a></li>
          <li class="line"></li>
          <li><a href="#" hidefocus="true" class="toolbar_delete" class="toolbar_delete"><s class="delicon"></s>删除</a></li>
        </ul>
        <div class="pages"></div>
      </div>
      <!--列表表格-->
