<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="ChangePwd.aspx.cs" Inherits="Enow.MAJU.Web.Manage.ChangePwd" %>
        ...
        <div class="firsttable">
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPwd" MaxLength="50" CssClass="input-txt formsize180" runat="server"
                            errmsg="请填写用户密码!" valid="required" TextMode="Password"></asp:TextBox>如不修改请置空
                    </td>
                </tr>
                <tr>
                    <th width="150" height="40" align="right">
                    ...
                    <td>
                        <asp:TextBox ID="txtPwd2" MaxLength="50" CssClass="input-txt formsize180" runat="server"
                            errmsg="请填写重复密码!" valid="required" TextMode="Password"></asp:TextBox>
            ...
            <div class="Basic_btn fixed">
                <ul>
                    ...
                    <li><a href="javascript:void(0);" onclick="javascript:window.history.go(-1);"
