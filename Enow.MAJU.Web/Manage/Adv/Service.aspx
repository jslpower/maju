<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/FinaWinBackPage.Master"
    AutoEventWireup="true" CodeBehind="Service.aspx.cs" Inherits="Enow.MAJU.Web.Manage.Adv.Service" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMain" runat="server">
    <div class="contentbox">
        <div class="searchbox fixed">
            <span class="searchT"></span>
        </div>
        <div class="listbox">
            <div id="tablehead" class="tablehead">
                <ul class="fixed">
                    <li class="line"></li>
                    <li><a href="#" hidefocus="true" class="add_gg"><s class="updateicon"></s>编辑</a></li>
                    <li class="line"></li>
                </ul>
            </div>
            <!--列表表格-->
