    ...
    public class EmailHelper
    {
        ...
        protected bool IsEnableSSL
        {
            get
            {
                ...
                Boolean.TryParse(Enow.MAJU.Utility.Function.UtilsCommons.GetConfigString("MailSettings", "IsEnableSSL"), out isenablessl);
                return isenablessl;
            }
        }
        /// <summary>
        ...
        protected string SendAddress
        {
            get
            {
                return Enow.MAJU.Utility.Function.UtilsCommons.GetConfigString("MailSettings", "SendAddress");
            }
        }
        /// <summary>
